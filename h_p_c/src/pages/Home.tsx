  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative p-8">
      <div className="max-w-4xl mx-auto relative">
        ...
        >
          <h1 className="text-5xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 via-fuchsia-500 to-violet-500 bg-clip-text text-transparent">
          ...
          <motion.div variants={item}>
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <h2 className="text-xl sm:text-lg md:text-xl font-bold bg-gradient-to-r from-purple-400 to-fuchsia-500 bg-clip-text text-transparent mb-2">
                  New User
                </h2>
